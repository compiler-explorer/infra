...
# Get SQS overflow configuration from SSM parameters
SQS_MAX_MESSAGE_SIZE=$(get_conf /compiler-explorer/sqsMaxMessageSize)
S3_OVERFLOW_BUCKET=$(get_conf /compiler-explorer/s3OverflowBucket)
S3_OVERFLOW_KEY_PREFIX=$(get_conf /compiler-explorer/s3OverflowKeyPrefix)
