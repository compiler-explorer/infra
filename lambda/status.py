...
ENVIRONMENTS = [
    ...
    {
        "name": "gpu-blue",
        "description": "GPU-blue",
        "url": "godbolt.org/gpu",
        "load_balancer": os.environ.get("GPU_LB_BLUE_ARN"),
        "is_production": True,
        "version_key": "version/gpu",
    },
    {
        "name": "gpu-green",
        "description": "GPU-green",
        "url": "godbolt.org/gpu",
        "load_balancer": os.environ.get("GPU_LB_GREEN_ARN"),
        "is_production": True,
        "version_key": "version/gpu",
    },
    {
        "name": "aarch64prod-blue",
        "description": "ARM64 Production-blue",
        "url": "godbolt.org/aarch64prod",
        "load_balancer": os.environ.get("ARM_PROD_LB_BLUE_ARN"),
        "is_production": True,
        "version_key": "version/aarch64prod",
    },
    {
        "name": "aarch64prod-green",
        "description": "ARM64 Production-green",
        "url": "godbolt.org/aarch64prod",
        "load_balancer": os.environ.get("ARM_PROD_LB_GREEN_ARN"),
        "is_production": True,
        "version_key": "version/aarch64prod",
    },
    {
        "name": "winprod-blue",
        "description": "Windows Production-blue",
        "url": "godbolt.org/winprod",
        "load_balancer": os.environ.get("WIN_PROD_LB_BLUE_ARN"),
        "is_production": True,
        "version_key": "version/winprod",
    },
    {
        "name": "winprod-green",
        "description": "Windows Production-green",
        "url": "godbolt.org/winprod",
        "load_balancer": os.environ.get("WIN_PROD_LB_GREEN_ARN"),
        "is_production": True,
        "version_key": "version/winprod",
    },
    ...
    {
        "name": "staging-blue",
        "description": "Staging-blue",
        "url": "godbolt.org/staging",
        "load_balancer": os.environ.get("STAGING_LB_BLUE_ARN"),
        "is_production": False,
        "version_key": "version/staging",
    },
    {
        "name": "staging-green",
        "description": "Staging-green",
        "url": "godbolt.org/staging",
        "load_balancer": os.environ.get("STAGING_LB_GREEN_ARN"),
        "is_production": False,
        "version_key": "version/staging",
    },
    {
        "name": "beta-blue",
        "description": "Beta-blue",
        "url": "godbolt.org/beta",
        "load_balancer": os.environ.get("BETA_LB_BLUE_ARN"),
        "is_production": False,
        "version_key": "version/beta",
    },
    {
        "name": "beta-green",
        "description": "Beta-green",
        "url": "godbolt.org/beta",
        "load_balancer": os.environ.get("BETA_LB_GREEN_ARN"),
        "is_production": False,
        "version_key": "version/beta",
    },
    {
        "name": "aarch64staging-blue",
        "description": "ARM64 Staging-blue",
        "url": "godbolt.org/aarch64staging",
        "load_balancer": os.environ.get("ARM_STAGING_LB_BLUE_ARN"),
        "is_production": False,
        "version_key": "version/aarch64staging",
    },
    {
        "name": "aarch64staging-green",
        "description": "ARM64 Staging-green",
        "url": "godbolt.org/aarch64staging",
        "load_balancer": os.environ.get("ARM_STAGING_LB_GREEN_ARN"),
        "is_production": False,
        "version_key": "version/aarch64staging",
    },
    {
        "name": "winstaging-blue",
        "description": "Windows Staging-blue",
        "url": "godbolt.org/winstaging",
        "load_balancer": os.environ.get("WIN_STAGING_LB_BLUE_ARN"),
        "is_production": False,
        "version_key": "version/winstaging",
    },
    {
        "name": "winstaging-green",
        "description": "Windows Staging-green",
        "url": "godbolt.org/winstaging",
        "load_balancer": os.environ.get("WIN_STAGING_LB_GREEN_ARN"),
        "is_production": False,
        "version_key": "version/winstaging",
    },
    {
        "name": "wintest-blue",
        "description": "Windows Test-blue",
        "url": "godbolt.org/wintest",
        "load_balancer": os.environ.get("WIN_TEST_LB_BLUE_ARN"),
        "is_production": False,
        "version_key": "version/wintest",
    },
    {
        "name": "wintest-green",
        "description": "Windows Test-green",
        "url": "godbolt.org/wintest",
        "load_balancer": os.environ.get("WIN_TEST_LB_GREEN_ARN"),
        "is_production": False,
        "version_key": "version/wintest",
    },
]
