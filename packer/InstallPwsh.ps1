...
Invoke-WebRequest -Uri "https://github.com/PowerShell/PowerShell/releases/download/v7.3.2/PowerShell-7.3.2-win-x64.msi" -Outfile "C:\tmp\PowerShell-7.3.2-win-x64.msi" -MaximumRetryCount 3
