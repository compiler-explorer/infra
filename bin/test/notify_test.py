...
class TestNotify(unittest.TestCase):
    ...
    def test_handle_notify_dry_run(self):
        ...
        with patch("lib.notify.list_inbetween_commits", return_value=mock_commits), \
             patch("lib.notify.get_linked_pr", return_value=mock_pr), \
             patch("lib.notify.send_live_message") as mock_send, \
             patch("lib.notify.get_linked_issues", return_value={"data": {"repository": {"pullRequest": {"closingIssuesReferences": {"edges": []}}}}}), \
...
class TestBlueGreenVersionHelpers(unittest.TestCase):
    ...
    def test_get_commit_hash_for_version(self):
        ...
        from lib.releases import Release, Hash, Version
        ...
        with patch("lib.cli.blue_green.get_releases", return_value=[mock_release]), \
    ...
    def test_get_commit_hash_for_version_not_found(self):
        ...
        with patch("lib.cli.blue_green.get_releases", return_value=[]), \
